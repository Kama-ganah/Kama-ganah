...
<h2>👨‍💻 Penetration Testing Projects:</h2>
  ...
  - [JWT authentication bypass via flawed signature verification in fintech webapp](https://github.com/Kama-ganah/JWT-authentication-bypass-via-flawed-signature-verification)
