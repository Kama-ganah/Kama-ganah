...
<h2>👨‍💻 Penetration Testing Projects:</h2>
  ...
  - [Bypassing access controls using email address parsing discrepancies in a business website](https://github.com/Kama-ganah/Bypassing-access-controls-using-email-address-parsing-discrepancies)
